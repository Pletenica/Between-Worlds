...
InputTextUI::InputTextUI(bool ismenu, GuiType type, j1GuiElement* p, SDL_Rect r, p2SString str, bool d) :j1GuiElement(type, r, p, d) {
	name.create("InputTextUI");
	stri = str;
	int w, h;
	boolmenu = ismenu;
}

bool InputTextUI::PostUpdate() {
